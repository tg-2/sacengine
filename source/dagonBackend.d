...
static:
	...
	Material createMaterial(SacParticle!DagonBackend particle){
		final switch(particle.type) with(ParticleType){
			case manafount, manalith, manahoar, shrine, firy, fire, fireball, explosion, explosion2, speedUp, heal, scarabHit, relativeHeal, ghostTransition, ghost, lightningCasting, chainLightningCasting, needle, freeze, etherealFormSpark, shard, redVortexDroplet, blueVortexDroplet, spark, castPersephone, castPersephone2, castPyro, castJames, castStratos, castCharnel, castCharnel2, wrathCasting, wrathExplosion1, wrathExplosion2, wrathParticle, rainOfFrogsCasting, gnomeHit, steam, ashParticle, smoke, dirt, dust, rock, webDebris, oil, poison, relativePoison, swarmHit, slime, locustBlood, locustDebris:
				auto mat=makeMaterial(scene.shadelessMaterialBackend);
				mat.depthWrite=false;
