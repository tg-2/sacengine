...
void serialize(alias sink,B,ParticleKind kind,bool sideFiltered)(ref Particles!(B,kind,sideFiltered) particles){ serializeStruct!sink(particles); }
void deserialize(T,R,B)(ref T result,ObjectState!B state,ref R data)if(is(T==Particles!(B,kind,sideFiltered),ParticleKind kind,bool sideFiltered)){ deserializeStruct(result,state,data); }
...
void serialize(alias sink,B)(ref VinewallCasting!B vinewallCasting){ serializeStruct!sink(vinewallCasting); }
void deserialize(T,R,B)(ref T result,ObjectState!B state,ref R data)if(is(T==VinewallCasting!B)){ deserializeStruct(result,state,data); }

void serialize(alias sink,B)(ref Vinewall!B.WallTarget target){ serializeStruct!sink(target); }
void deserialize(T,R,B)(ref T result,ObjectState!B state,ref R data)if(is(T==Vinewall!B.WallTarget)){ deserializeStruct(result,state,data); }

void serialize(alias sink,B)(ref Vinewall!B vinewall){ serializeStruct!sink(vinewall); }
void deserialize(T,R,B)(ref T result,ObjectState!B state,ref R data)if(is(T==Vinewall!B)){ deserializeStruct(result,state,data); }
...
void serialize(alias sink,B)(ref RainOfFireCasting!B rainOfFireCasting){ serializeStruct!sink(rainOfFireCasting); }
void deserialize(T,R,B)(ref T result,ObjectState!B state,ref R data)if(is(T==RainOfFireCasting!B)){ deserializeStruct(result,state,data); }

void serialize(alias sink,B)(ref RainOfFire!B rainOfFire){ serializeStruct!sink(rainOfFire); }
void deserialize(T,R,B)(ref T result,ObjectState!B state,ref R data)if(is(T==RainOfFire!B)){ deserializeStruct(result,state,data); }
...
void serialize(alias sink,B)(ref DeathCasting!B deathCasting){ serializeStruct!sink(deathCasting); }
void deserialize(T,R,B)(ref T result,ObjectState!B state,ref R data)if(is(T==DeathCasting!B)){ deserializeStruct(result,state,data); }

void serialize(alias sink,B)(ref Death!B death){ serializeStruct!sink(death); }
void deserialize(T,R,B)(ref T result,ObjectState!B state,ref R data)if(is(T==Death!B)){ deserializeStruct(result,state,data); }
...
void serialize(alias sink,B)(ObjectState!B state){
	enum noserialize=["map","sides","proximity","pathFinder","dangerGrid","triggers","toRemove",/+"cachedState","cachedHash","hashCached"+/];
